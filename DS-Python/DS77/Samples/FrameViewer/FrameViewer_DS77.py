...
if  ret == 0:
    ...
    try:
        while 1:
            ...
            print(frameready.depth,frameready.ir,frameready.color,frameready.transformedColor,frameready.transformedDepth \
                ,frameready.transformedIR,frameready.confidence)             
            if  frameready.depth:      
